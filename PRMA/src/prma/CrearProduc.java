...
public class CrearProduc extends javax.swing.JFrame {
    ...
    for (int i = 0; i < modeloPedido.getRowCount(); i++) {
        ...
        crud.guardarPedidoConIDProd(idPedido, nombre, precio, cantidad, total);  // Método que guarda con el ID del pedido
        totalPedido += total;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearProduc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrearProduc().setVisible(true);
            }
        });
    }
